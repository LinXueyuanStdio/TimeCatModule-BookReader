...
class AudioPlayService : BaseService(),
    ...
    private fun upNotification() {
        ...
        val builder = NotificationCompat.Builder(this, AppConst.channelIdReadAloud)
            .setSmallIcon(R.drawable.novel_ic_volume_up)
            .setLargeIcon(BitmapFactory.decodeResource(resources, R.drawable.novel_icon_read_book))
            .setOngoing(true)
        ...
        if (pause) {
            builder.addAction(
                R.drawable.novel_ic_play_24dp,
                getString(R.string.resume),
                thisPendingIntent(IntentAction.resume)
            )
        } else {
            builder.addAction(
                R.drawable.novel_ic_pause_24dp,
                getString(R.string.pause),
                thisPendingIntent(IntentAction.pause)
            )
        }
        builder.addAction(
            R.drawable.novel_ic_stop_black_24dp,
            getString(R.string.stop),
            thisPendingIntent(IntentAction.stop)
        )
        builder.addAction(
            R.drawable.novel_ic_time_add_24dp,
