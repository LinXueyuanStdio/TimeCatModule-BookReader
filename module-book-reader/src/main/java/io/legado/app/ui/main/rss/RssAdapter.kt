...
import kotlinx.android.synthetic.main.novel_item_rss.view.*
import org.jetbrains.anko.sdk27.listeners.onClick
import org.jetbrains.anko.sdk27.listeners.onLongClick

class RssAdapter(context: Context, val callBack: CallBack) :
    SimpleRecyclerAdapter<RssSource>(context, R.layout.novel_item_rss) {
        ...
        with(holder.itemView) {
            ...
            ImageLoader.load(context, item.sourceIcon)
                .apply(
                    RequestOptions()
                    .centerCrop()
                .placeholder(R.drawable.novel_image_rss)
                .error(R.drawable.novel_image_rss))
                .into(iv_icon)
        }
    }
    ...
    private fun showMenu(view: View, rssSource: RssSource) {
        ...
        popupMenu.inflate(R.menu.novel_rss_main_item)
