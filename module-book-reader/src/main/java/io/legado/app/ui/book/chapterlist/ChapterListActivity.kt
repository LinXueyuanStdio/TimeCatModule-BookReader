...
import kotlinx.android.synthetic.main.novel_activity_chapter_list.*
import kotlinx.android.synthetic.main.view_tab_layout.*


class ChapterListActivity : VMBaseActivity<ChapterListViewModel>(R.layout.novel_activity_chapter_list) {
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_search_view, menu)
