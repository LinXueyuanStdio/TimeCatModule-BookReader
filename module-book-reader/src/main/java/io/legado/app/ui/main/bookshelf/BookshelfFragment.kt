...
import kotlinx.android.synthetic.main.novel_dialog_bookshelf_config.view.*
import kotlinx.android.synthetic.main.novel_dialog_edit_text.view.*
import kotlinx.android.synthetic.main.novel_fragment_bookshelf.*
...
open class BookshelfFragment : VMBaseFragment<BookshelfViewModel>(R.layout.novel_fragment_bookshelf),
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu) {
        menuInflater.inflate(R.menu.novel_main_bookshelf, menu)
    }
    ...
    private fun configBookshelf() {
        requireContext().alert(titleResource = R.string.bookshelf_layout) {
            ...
            val root = LayoutInflater.from(requireContext())
                .inflate(R.layout.novel_dialog_bookshelf_config, null).apply {
