...
import kotlinx.android.synthetic.main.novel_dialog_replace_edit.*
...
class ReplaceEditDialog : BaseDialogFragment(),
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.novel_dialog_replace_edit, container)
    }
    ...
    override fun onFragmentCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tool_bar.inflateMenu(R.menu.novel_replace_edit)
