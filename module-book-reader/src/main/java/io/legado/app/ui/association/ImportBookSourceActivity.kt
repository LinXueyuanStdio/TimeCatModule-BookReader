...
import kotlinx.android.synthetic.main.novel_activity_translucence.*
...
import kotlinx.android.synthetic.main.novel_item_source_import.view.*
import org.jetbrains.anko.sdk27.listeners.onClick
import org.jetbrains.anko.toast


class ImportBookSourceActivity : VMBaseActivity<ImportBookSourceViewModel>(
    R.layout.novel_activity_translucence,
    ...
    class SourcesDialog : BaseDialogFragment(), Toolbar.OnMenuItemClickListener {
        ...
        private fun initMenu() {
            ...
            tool_bar.inflateMenu(R.menu.novel_import_source)
        }
    ...
    class SourcesAdapter(context: Context) :
        SimpleRecyclerAdapter<BookSource>(context, R.layout.novel_item_source_import) {
