...
import kotlinx.android.synthetic.main.novel_item_rss_source.view.*
import org.jetbrains.anko.sdk27.listeners.onClick
import java.util.*

class RssSourceAdapter(context: Context, val callBack: CallBack) :
    SimpleRecyclerAdapter<RssSource>(context, R.layout.novel_item_rss_source),
    ...
    private fun showMenu(view: View, position: Int) {
        ...
        popupMenu.inflate(R.menu.novel_rss_source_item)
