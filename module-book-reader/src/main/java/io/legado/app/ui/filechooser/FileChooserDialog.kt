...
import kotlinx.android.synthetic.main.novel_dialog_file_chooser.*
...
class FileChooserDialog : DialogFragment(),
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.novel_dialog_file_chooser, container, true)
    }
    ...
    private fun initMenu() {
        tool_bar.inflateMenu(R.menu.novel_file_chooser)
        if (isSelectDir) {
