...
import kotlinx.android.synthetic.main.novel_activity_rss_artivles.*
import org.jetbrains.anko.startActivityForResult

class RssSortActivity : VMBaseActivity<RssSortViewModel>(R.layout.novel_activity_rss_artivles) {
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_rss_articles, menu)
