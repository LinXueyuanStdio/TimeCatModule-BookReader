...
import kotlinx.android.synthetic.main.novel_activity_book_read.*
import kotlinx.android.synthetic.main.novel_dialog_read_book_style.*
import kotlinx.android.synthetic.main.novel_dialog_title_config.view.*
import kotlinx.android.synthetic.main.novel_item_read_style.view.*
...
class ReadStyleDialog : BaseDialogFragment(), FontSelectDialog.CallBack {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.novel_dialog_read_book_style, container)
    }
    ...
    private fun initView() {
        ...
        val footerView = LayoutInflater.from(requireContext())
            .inflate(R.layout.novel_item_read_style, rv_style, false)
        ...
        footerView.iv_style.setImageResource(R.drawable.novel_ic_add)
    ...
    private fun showTitleConfig() = ReadBookConfig.apply {
        requireContext().alert(R.string.title) {
            val rootView = LayoutInflater.from(requireContext())
                .inflate(R.layout.novel_dialog_title_config, null).apply {
    ...
    inner class StyleAdapter :
        SimpleRecyclerAdapter<ReadBookConfig.Config>(requireContext(), R.layout.novel_item_read_style) {
