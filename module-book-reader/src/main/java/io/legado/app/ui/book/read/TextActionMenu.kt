...
class TextActionMenu(private val context: Context, private val callBack: CallBack) :
    ...
    init {
        ...
        setOnDismissListener {
            contentView.apply {
                iv_menu_more.setImageResource(R.drawable.novel_ic_more_vert)
    ...
    private fun initRecyclerView() = with(contentView) {
        ...
        SupportMenuInflater(context).inflate(R.menu.novel_content_select_action, menu)
        adapter.setItems(menu.visibleItems)
        ...
        iv_menu_more.onClick {
            if (recycler_view.isVisible) {
                iv_menu_more.setImageResource(R.drawable.novel_ic_arrow_back)
    ...
    inner class Adapter(context: Context) :
        SimpleRecyclerAdapter<MenuItemImpl>(context, R.layout.novel_item_text) {
