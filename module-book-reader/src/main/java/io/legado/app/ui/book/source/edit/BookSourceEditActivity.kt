...
import kotlinx.android.synthetic.main.novel_activity_book_source_edit.*
import org.jetbrains.anko.*
import kotlin.math.abs

class BookSourceEditActivity :
    VMBaseActivity<BookSourceEditViewModel>(R.layout.novel_activity_book_source_edit, false),
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_source_edit, menu)
