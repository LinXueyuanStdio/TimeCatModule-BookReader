...
import kotlinx.android.synthetic.main.novel_activity_book_source.*
import kotlinx.android.synthetic.main.novel_activity_book_source.recycler_view
import kotlinx.android.synthetic.main.novel_dialog_edit_text.view.*
import kotlinx.android.synthetic.main.novel_dialog_progressbar_view.*
import kotlinx.android.synthetic.main.novel_dialog_progressbar_view.tv_footer_left
...
class BookSourceActivity : VMBaseActivity<BookSourceViewModel>(R.layout.novel_activity_book_source),
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_book_source, menu)
        ...
        when (item.itemId) {
            ...
            R.id.menu_share_source -> {
                try {
                    ...
                    file.writeText(json)
                    val fileUri = FileProvider.getUriForFile(this, "com.time.cat.file.provider", file)
                    intent.type = "text/*"
    ...
    private fun initSelectActionBar() {
        ...
        select_action_bar.inflateMenu(R.menu.novel_book_source_sel)
    ...
    class CheckSourceDialog : BaseDialogFragment() {
        ...
        override fun onCreateView(
            ...
            return inflater.inflate(R.layout.novel_dialog_progressbar_view, container)
        }
