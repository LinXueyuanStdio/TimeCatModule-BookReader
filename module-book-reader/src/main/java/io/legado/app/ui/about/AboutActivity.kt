...
import kotlinx.android.synthetic.main.novel_activity_about.*
import org.jetbrains.anko.share


class AboutActivity : BaseActivity(R.layout.novel_activity_about) {
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_about, menu)
