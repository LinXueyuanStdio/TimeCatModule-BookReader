...
import kotlinx.android.synthetic.main.novel_item_theme_config.view.*
...
class ThemeListDialog : BaseDialogFragment(), Toolbar.OnMenuItemClickListener {
    ...
    private fun initMenu() {
        ...
        tool_bar.inflateMenu(R.menu.novel_theme_list)
    ...
    inner class Adapter : SimpleRecyclerAdapter<ThemeConfig.Config>(requireContext(), R.layout.novel_item_theme_config) {
