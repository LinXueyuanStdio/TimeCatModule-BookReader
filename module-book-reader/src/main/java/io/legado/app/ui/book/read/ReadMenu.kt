...
class ReadMenu : FrameLayout {
    ...
    init {
        ...
        if (AppConfig.isNightTheme) {
            fabNightTheme.setImageResource(R.drawable.novel_ic_daytime)
        } else {
            fabNightTheme.setImageResource(R.drawable.novel_ic_brightness)
        }
        initAnimation()
    ...
    fun setAutoPage(autoPage: Boolean) {
        if (autoPage) {
            fabAutoPage.setImageResource(R.drawable.novel_ic_auto_page_stop)
            fabAutoPage.contentDescription = context.getString(R.string.auto_next_page_stop)
        } else {
            fabAutoPage.setImageResource(R.drawable.novel_ic_auto_page)
