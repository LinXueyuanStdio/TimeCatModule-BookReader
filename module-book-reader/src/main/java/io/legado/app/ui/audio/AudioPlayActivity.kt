...
import kotlinx.android.synthetic.main.novel_activity_audio_play.*
...
class AudioPlayActivity :
    VMBaseActivity<AudioPlayViewModel>(R.layout.novel_activity_audio_play, toolBarTheme = Theme.Dark),
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_audio_play, menu)
    ...
    override fun observeLiveBus() {
        ...
        observeEventSticky<Int>(EventBus.AUDIO_STATE) {
            AudioPlay.status = it
            if (it == Status.PLAY) {
                fab_play_stop.setImageResource(R.drawable.novel_ic_pause_24dp)
            } else {
                fab_play_stop.setImageResource(R.drawable.novel_ic_play_24dp)
            }
        }
