...
import kotlinx.android.synthetic.main.novel_item_book_source.view.*
import org.jetbrains.anko.sdk27.listeners.onClick
import java.util.*

class BookSourceAdapter(context: Context, val callBack: CallBack) :
    SimpleRecyclerAdapter<BookSource>(context, R.layout.novel_item_book_source),
    ...
    private fun showMenu(view: View, position: Int) {
        ...
        popupMenu.inflate(R.menu.novel_book_source_item)
