...
import kotlinx.android.synthetic.main.novel_item_replace_rule.view.*
import org.jetbrains.anko.sdk27.listeners.onClick
import java.util.*


class ReplaceRuleAdapter(context: Context, var callBack: CallBack) :
    SimpleRecyclerAdapter<ReplaceRule>(context, R.layout.novel_item_replace_rule),
    ...
    private fun showMenu(view: View, position: Int) {
        ...
        popupMenu.inflate(R.menu.novel_replace_rule_item)
