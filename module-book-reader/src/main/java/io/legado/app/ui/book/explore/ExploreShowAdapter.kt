...
import kotlinx.android.synthetic.main.novel_item_bookshelf_list.view.iv_cover
import kotlinx.android.synthetic.main.novel_item_bookshelf_list.view.tv_name
import kotlinx.android.synthetic.main.novel_item_search.view.*
import org.jetbrains.anko.sdk27.listeners.onClick

class ExploreShowAdapter(context: Context, val callBack: CallBack) :
    SimpleRecyclerAdapter<SearchBook>(context, R.layout.novel_item_search) {
