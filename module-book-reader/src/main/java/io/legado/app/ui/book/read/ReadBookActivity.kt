...
@RouterAnno(hostAndPath = RouterHub.NOVEL_ReadBookActivity)
class ReadBookActivity : VMBaseActivity<ReadBookViewModel>(R.layout.novel_activity_book_read),
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_read_book, menu)
    ...
    private fun upMenu() {
        menu?.let { menu ->
            ReadBook.book?.let { book ->
                val forumId = "forum".hashCode()
                val forumItem = menu.findItem(forumId)
                if (forumItem == null) {
                    menu.add("timecat".hashCode(), forumId, 0,"论坛")
                }
