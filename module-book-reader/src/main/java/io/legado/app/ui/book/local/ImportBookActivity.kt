...
import kotlinx.android.synthetic.main.novel_activity_import_book.*
...
class ImportBookActivity : VMBaseActivity<ImportBookViewModel>(R.layout.novel_activity_import_book),
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_import_book, menu)
    ...
    private fun initView() {
        ...
        select_action_bar.inflateMenu(R.menu.novel_import_book_sel)
