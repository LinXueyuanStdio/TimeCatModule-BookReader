...
import kotlinx.android.synthetic.main.novel_activity_arrange_book.*


class ArrangeBookActivity : VMBaseActivity<ArrangeBookViewModel>(R.layout.novel_activity_arrange_book),
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_arrange_book, menu)
    ...
    private fun initView() {
        ...
        select_action_bar.inflateMenu(R.menu.novel_arrange_book_sel)
