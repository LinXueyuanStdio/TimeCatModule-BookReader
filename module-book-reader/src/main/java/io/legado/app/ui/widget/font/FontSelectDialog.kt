...
import kotlinx.android.synthetic.main.novel_dialog_font_select.*
...
class FontSelectDialog : BaseDialogFragment(),
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.novel_dialog_font_select, container)
    }

    override fun onFragmentCreated(view: View, savedInstanceState: Bundle?) {
        tool_bar.setBackgroundColor(primaryColor)
        tool_bar.setTitle(R.string.select_font)
        tool_bar.inflateMenu(R.menu.novel_font_select)
