...
import kotlinx.android.synthetic.main.novel_item_icon_preference.view.*
...
class IconListPreference(context: Context, attrs: AttributeSet) : ListPreference(context, attrs) {
    ...
    init {
        layoutResource = R.layout.novel_view_preference
        widgetLayoutResource = R.layout.novel_view_icon
    ...
    class IconDialog : BaseDialogFragment() {
        ...
        inner class Adapter(context: Context) :
            SimpleRecyclerAdapter<CharSequence>(context, R.layout.novel_item_icon_preference) {
