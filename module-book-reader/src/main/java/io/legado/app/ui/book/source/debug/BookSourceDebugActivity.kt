...
import kotlinx.android.synthetic.main.novel_activity_source_debug.*
...
class BookSourceDebugActivity :
    VMBaseActivity<BookSourceDebugModel>(R.layout.novel_activity_source_debug) {
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_source_debug, menu)
