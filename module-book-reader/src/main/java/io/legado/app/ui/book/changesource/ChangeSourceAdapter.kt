...
import kotlinx.android.synthetic.main.novel_item_change_source.view.*
import org.jetbrains.anko.sdk27.listeners.onClick
import org.jetbrains.anko.sdk27.listeners.onLongClick


class ChangeSourceAdapter(context: Context, val callBack: CallBack) :
    SimpleRecyclerAdapter<SearchBook>(context, R.layout.novel_item_change_source) {
    ...
    private fun showMenu(view: View, searchBook: SearchBook?) {
        ...
        popupMenu.inflate(R.menu.novel_change_source_item)
