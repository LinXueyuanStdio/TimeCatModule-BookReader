...
import kotlinx.android.synthetic.main.novel_activity_book_info.*
...
@RouterAnno(hostAndPath = RouterHub.NOVEL_BookDetailActivity)
class BookInfoActivity :
    VMBaseActivity<BookInfoViewModel>(R.layout.novel_activity_book_info, toolBarTheme = Theme.Dark),
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_book_info, menu)
