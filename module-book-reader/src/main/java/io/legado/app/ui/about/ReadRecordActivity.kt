...
import kotlinx.android.synthetic.main.novel_activity_read_record.*
import kotlinx.android.synthetic.main.novel_item_read_record.*
import kotlinx.android.synthetic.main.novel_item_read_record.view.*
...
class ReadRecordActivity : BaseActivity(R.layout.novel_activity_read_record) {
    ...
    inner class RecordAdapter(context: Context) :
        SimpleRecyclerAdapter<ReadRecordShow>(context, R.layout.novel_item_read_record) {
