...
import kotlinx.android.synthetic.main.novel_activity_source_login.*


class SourceLogin : BaseActivity(R.layout.novel_activity_source_login) {
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_source_login, menu)
