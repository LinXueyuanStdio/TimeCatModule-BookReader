...
import kotlinx.android.synthetic.main.novel_dialog_http_tts_edit.view.*
import kotlinx.android.synthetic.main.novel_dialog_recycler_view.*
import kotlinx.android.synthetic.main.novel_item_http_tts.view.*
...
class SpeakEngineDialog : BaseDialogFragment(), Toolbar.OnMenuItemClickListener {
    ...
    private fun initMenu() {
        tool_bar.inflateMenu(R.menu.novel_speak_engine)
        ...
        requireContext().alert(titleResource = R.string.speak_engine) {
            ...
            customView {
                LayoutInflater.from(requireContext())
                    .inflate(R.layout.novel_dialog_http_tts_edit, null).apply {
                        rootView = this
    ...
    inner class Adapter(context: Context) :
        SimpleRecyclerAdapter<HttpTTS>(context, R.layout.novel_item_http_tts) {
