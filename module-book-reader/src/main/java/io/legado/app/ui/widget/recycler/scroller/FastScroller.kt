...
class FastScroller : LinearLayout {
    ...
    fun setTrackColor(@ColorInt color: Int) {
        if (mTrackImage == null) {
            val drawable = ContextCompat.getDrawable(context, R.drawable.novel_fastscroll_track)
            if (drawable != null) {
    ...
    fun setHandleColor(@ColorInt color: Int) {
        ...
        if (mHandleImage == null) {
            val drawable = ContextCompat.getDrawable(context, R.drawable.novel_fastscroll_handle)
            if (drawable != null) {
    ...
    fun setBubbleColor(@ColorInt color: Int) {
        ...
        if (mBubbleImage == null) {
            val drawable = ContextCompat.getDrawable(context, R.drawable.novel_fastscroll_bubble)
            if (drawable != null) {
    ...
    private fun layout(context: Context, attrs: AttributeSet?) {
        View.inflate(context, R.layout.novel_view_fastscroller, this)
        clipChildren = false
