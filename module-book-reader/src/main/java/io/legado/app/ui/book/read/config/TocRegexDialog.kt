...
import kotlinx.android.synthetic.main.novel_dialog_toc_regex.*
import kotlinx.android.synthetic.main.novel_dialog_toc_regex_edit.view.*
import kotlinx.android.synthetic.main.novel_item_toc_regex.view.*
...
class TocRegexDialog : BaseDialogFragment(), Toolbar.OnMenuItemClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.novel_dialog_toc_regex, container)
    }
    ...
    override fun onFragmentCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tool_bar.inflateMenu(R.menu.novel_txt_toc_regex)
        ...
        requireContext().alert(titleResource = R.string.txt_toc_regex) {
            ...
            customView {
                LayoutInflater.from(requireContext())
                    .inflate(R.layout.novel_dialog_toc_regex_edit, null).apply {
                        rootView = this
    ...
    inner class TocRegexAdapter(context: Context) :
        SimpleRecyclerAdapter<TxtTocRule>(context, R.layout.novel_item_toc_regex),
