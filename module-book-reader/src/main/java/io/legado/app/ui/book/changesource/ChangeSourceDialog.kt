...
import kotlinx.android.synthetic.main.novel_dialog_change_source.*
...
class ChangeSourceDialog : BaseDialogFragment(),
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.novel_dialog_change_source, container)
    }
    ...
    private fun initMenu() {
        tool_bar.inflateMenu(R.menu.novel_change_source)
    ...
    private fun initLiveData() {
        viewModel.searchStateData.observe(viewLifecycleOwner, {
            ...
            if (it) {
                stopMenuItem?.setIcon(R.drawable.novel_ic_stop_black_24dp)
            } else {
                stopMenuItem?.setIcon(R.drawable.novel_ic_refresh_black_24dp)
            }
            tool_bar.menu.applyTint(requireContext())
        })
