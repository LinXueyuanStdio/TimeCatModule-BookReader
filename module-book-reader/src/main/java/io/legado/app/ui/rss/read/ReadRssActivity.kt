...
import kotlinx.android.synthetic.main.novel_activity_rss_read.*
...
class ReadRssActivity : VMBaseActivity<ReadRssViewModel>(R.layout.novel_activity_rss_read, false),
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.novel_rss_read, menu)
    ...
    override fun upStarMenu() {
        if (viewModel.rssStar != null) {
            starMenuItem?.setIcon(R.drawable.novel_ic_star)
            starMenuItem?.setTitle(R.string.in_favorites)
        } else {
            starMenuItem?.setIcon(R.drawable.novel_ic_star_border)
    ...
    override fun upTtsMenu(isPlaying: Boolean) {
        launch {
            if (isPlaying) {
                ttsMenuItem?.setIcon(R.drawable.novel_ic_stop_black_24dp)
                ttsMenuItem?.setTitle(R.string.aloud_stop)
            } else {
                ttsMenuItem?.setIcon(R.drawable.novel_ic_volume_up)
